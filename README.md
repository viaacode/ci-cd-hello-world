...
1. Clone this repository with:
    ...
    `$ git clone https://github.com/viaacode/ci-cd-hello-world.git`
...
The application is now serving requests on `localhost:8080`. Try it with:
    ...
    `$ curl -v -X GET localhost:8080/hello`

### Running using Docker

1. Build the container:

   `$ docker build . -t ci-cd-hello-world`

2. Run the container:

   `$ docker run -p 8080:8080 ci-cd-hello-world`
